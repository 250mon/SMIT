...
class Config(object):
    ...
    dataset_root = '/mnt/e/Datasets'
    dataset_dir = 'cityscape_subset'
    cityscape_data={
            'train_img_path': os.path.join(dataset_root, dataset_dir, 'leftImg8bit', 'train'),
            'train_label_path': os.path.join(dataset_root, dataset_dir, 'gtFine', 'train'),
            'class_num': 19,
