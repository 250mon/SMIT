...
class LevelManager:
    def __init__(self, ic_net):
        self.level5 = Level5(ic_net, self)
        self.level4 = Level4(ic_net, self)
        self.level3 = Level3(ic_net, self)
        self.level2 = Level2(ic_net, self)
        self.level1 = Level1(ic_net, self)
        self.level0 = Level0(ic_net, self)
        # for debugging
...
class Level0(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main'):
...
class Level1(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main1'):
        super().__init__(term_name)
        self.ic_net = ic_net
...
class Level2(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main2'):
        super().__init__(term_name)
        self.ic_net = ic_net
...
class Level3(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main3'):
        super().__init__(term_name)
        self.ic_net = ic_net
...
class Level4(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main4'):
        super().__init__(term_name)
        self.ic_net = ic_net
...
class Level5(nls.Layer):
    def __init__(self, ic_net, level_mgr, term_name='main5'):
        super().__init__(term_name)
        self.ic_net = ic_net
        self.lvl_mgr = level_mgr
        self.net_params = ic_net.net_params
