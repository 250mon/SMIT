...
class _TerminalHandler:
    def __init__(self):
        self.terminals = {}
        # create a default terminal named 'main'
...
class Layer:
    # it will use the terminal "main" by default,
...
class DenseLayer(Layer):
    ...
    def op(self, iin_nodes=10, iout_nodes=10, buse_bias=True, sname=None, *args, **kwargs):
...
class ConvLayer(Layer):
    ...
    def op(self, lfilter_shape=(3, 3, 1, 1), istride=1, buse_bias=False, sname=None, *args, **kwargs):
        with tf.variable_scope(sname, reuse=tf.AUTO_REUSE):
            tinputs = self.retrieve_from_terminal()
            # netparam as default
