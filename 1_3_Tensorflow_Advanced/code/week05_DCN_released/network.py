...
def layer(op):
    ...
    def layer_decorated(self, *args, **kwargs):
        ...
        if len(self.terminals) == 0:
            ...
            raise NotImplementedError('List Inputs - Not implemented yet %s.' %
                                      name)
...
class Network(object):
    ...
    def _build(self):
        ...
        raise NotImplementedError(
            'Must be implemented by the subclass in model.py')
        ...
        with tf.variable_scope(sname, reuse=tf.AUTO_REUSE):
            ...
            if sactivation != 'None':
                if sactivation == 'ReLu':
                    ...
                    raise NotImplementedError(
                        'sactivation parameter is not defined in %s' % sname)
    ...
    * sname:          layer name
    ...
    @layer
    def maxpool(self, tinputs, ipool_size=2, sname=None):
