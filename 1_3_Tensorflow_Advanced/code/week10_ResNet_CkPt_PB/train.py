...
def main():
    ...
    cifar10 = utils.Cifar10Reader(cfg)
    ...
    _train_op, _wd_loss, _loss, _logits, _sum_vgg, _output = net.optimizer()
    ...
    for epoch in range(st_epoch, cfg.num_epoch):
        ...
        if (epoch+1)%4 == 0:
            ...
            for setp in range(cifar10.eval_num):
                ...
                output = net.sess.run([_output], feed_dict=feed_dict)
                
                correct_prediction = np.equal(output, eval_label)
